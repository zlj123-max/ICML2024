...
def main(args):
    ...
    agent_conf = "agent_conf-" + all_args.agent_conf[0] + "-" + all_args.agent_conf[2]
    run_dir = Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[
                       0] + "/results") / all_args.env_name / all_args.scenario / all_args.algorithm_name/agent_conf/ all_args.experiment_name
