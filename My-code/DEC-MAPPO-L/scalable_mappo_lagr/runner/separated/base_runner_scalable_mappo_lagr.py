...
from scalable_mappo_lagr.utils.separated_buffer import SeparatedReplayBuffer
from scalable_mappo_lagr.utils.util import update_linear_schedule
...
class Runner(object):
    def __init__(self, config):
        ...
        from scalable_mappo_lagr.algorithms.r_mappo.r_mappo_lagr import R_MAPPO_Lagr as TrainAlgo
        from scalable_mappo_lagr.algorithms.r_mappo.algorithm.MACPPOPolicy import MACPPOPolicy as Policy
        ...
        self.trainer = []
        self.buffer = []
        print("self.envs.observation_space[agent_id]", self.envs.observation_space[0])
