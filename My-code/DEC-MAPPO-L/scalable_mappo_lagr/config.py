...
def get_config():
    ...
    parser = argparse.ArgumentParser(
        description='scalable_mappo_lagr', formatter_class=argparse.RawDescriptionHelpFormatter)

    # prepare parameters
    parser.add_argument("--algorithm_name", type=str,
                        default=' ', choices=[ "scalable_mappo_lagr"])
    ...
    parser.add_argument("--share_policy", action='store_false', 
                        default=False, help='Whether agent share the same policy')              #zlj 2024-01-03 False
    parser.add_argument("--use_centralized_V", action='store_false',
                        default=False, help="Whether to use centralized V function")            #zlj 2023-12-17 False
    ...
    # todo: lagrangian_coef is the lagrangian coefficient for scalable_mappo_lagr
